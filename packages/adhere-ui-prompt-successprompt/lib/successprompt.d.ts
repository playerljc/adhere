 ...
 * ```
 */
export declare const openSuccessMessage: (content?: JointContent, duration?: Duration, onClose?: VoidFunction) => void;
/**
 * 显示成功消息提示（对象参数版本）
 *
 ...
 * ```
 */
export declare const openSuccessMessageWithParams: (params: SuccessMessageParams) => void;
/**
 * 清理全局定时器
 *
 ...
 * ```
 */
export declare const clearSuccessDialogTimer: () => void;
