import { IInteractionLayer, IPoint, IStyle, ITriangleData, SelectType } from '../types';
...
declare class TriangleDrawAction extends DrawAction {
     ...
     * @param data
     */
    static booleanPointInData(context: IInteractionLayer, point: IPoint, data: ITriangleData): boolean;
    /**
     * draw
     * @param e
     */
     ...
     * @param data
     */
    static draw(context: IInteractionLayer, ctx: CanvasRenderingContext2D, data: ITriangleData): void;
    /**
