...
import GTList from '../List/List/GTList';
import GTMList from '../List/List/GTMList';
import TopicsList from '../List/List/TopicsList';
...
export default () => {
  ...
  const renderList = useCallback(
    ({ dataSource, actionTriggerMode }) => {
      let list;

      switch (viewMode) {
        case 'Topics':
          list = <TopicsList data={dataSource} actionTriggerMode={actionTriggerMode} />;
          break;
        case 'GT':
          list = <GTList data={dataSource} actionTriggerMode={actionTriggerMode} />;
          break;
        case 'GTM':
          list = <GTMList data={dataSource} actionTriggerMode={actionTriggerMode} />;
          break;
      }
    ...
    <div className={styles.Wrapper}>
      <MobilePRSL
        ...
        onDNDChange={(sortChangeValue) => {
          console.log('sortChangeValue', sortChangeValue);
        }}
        isUseFirstLoading
