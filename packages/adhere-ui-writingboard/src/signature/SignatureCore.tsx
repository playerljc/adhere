 ...
 * @constructor
 */
const Signature: ForwardRefRenderFunction<SignatureCoreHandle, SignatureCoreProps> = (
...
export default memo(forwardRef<SignatureCoreHandle, SignatureCoreProps>(Signature));
