    ...
    components?: {
        normal?: {
            ...
            Notification?: {
                ...
                standardContentRowTextColor?: string;
                standardContentRowTexteFontSize?: string;
                standardContentRowTexteLineHeight?: string;
                iosStandardContentRowTitleColor?: string;
                materialStandardContentRowTitleColor?: string;
                materialUlLiInfoStandardHeaderBorderBottom?: string;
                standardContentMediaRColor?: string;
                closeBtnTop?: string;
            ...
            SearchTable?: {
                ...
                advancedSearchPanelTitleColor?: string;
                ...
                advancedSearchPanelMainTableGridLayoutTableRowValueLineHeight?: string;
                ...
                rowDragSortDraggingOpacity?: string;
                rowDragSortDraggingBg?: string;
                rowDragSortHoverTargetBg?: string;
            ...
            Surnames?: {
                ...
                configPositionTopBottomIndexInnerPadding?: string;
            ...
            TableGridLayout?: {
                ...
                tableRowLabelRequireAfterMarginLeft?: string;
                tableRowLabelRequireAfterColor?: string;
                tableRowLabelRequireAfterVerticalAlign?: string;
        ...
        mobile?: {
            ...
            PopoverMenu?: {
                ...
                menuItemIconPadingRight?: string;
        ...
        'normal-hoc'?: {
            ...
            segmentedTabsGap?: string;
            segmentedTabsExtraGap?: string;
            segmentedTabsTrackPadding?: string;
            segmentedTabsTrackBg?: string;
            segmentedTabsBorderRadius?: string;
            segmentedTabsItemGap?: string;
            segmentedTabsItemHeight?: string;
            segmentedTabsItemPaddingInline?: string;
            segmentedTabsItemColor?: string;
            segmentedTabsItemRadius?: string;
            segmentedTabsItemTransition?: string;
            segmentedTabsItemHoverTransition?: string;
            segmentedTabsItemHoverColor?: string;
            segmentedTabsItemHoverBg?: string;
            segmentedTabsItemSelectedColor?: string;
            segmentedTabsItemSelectedBg?: string;
            segmentedTabsItemSelectedShadow?: string;
            segmentedTabsItemDisabledColor?: string;
            segmentedTabsItemHeightLg?: string;
            segmentedTabsItemPaddingInlineLg?: string;
            segmentedTabsItemHeightSm?: string;
            segmentedTabsItemPaddingInlineSm?: string;
            segmentedTabsItemLabelGap?: string;
            segmentedTabsRemoveFontSize?: string;
            segmentedTabsRemoveOpacity?: string;
            segmentedTabsRemoveMarginInlineStart?: string;
            segmentedTabsRemoveHoverOpacity?: string;
            segmentedTabsAddPaddingInline?: string;
            segmentedTabsAddMarginInlineStart?: string;
        };
        'mobile-hoc'?: {
        ...
        'form-design'?: {
            areaCodePhoneDataSourceFormItemBodyWidth?: string;
            areaCodePhoneDataSourceFormItemDynamicGap?: string;
            areaCodePhoneDataSourceFormItemDynamicNavMinWidth?: string;
            areaCodePhoneDataSourceFormItemGap?: string;
            areaCodePhoneDataSourceFormItemWidth?: string;
            colgroupValueSettingLiNotLastChildMarginBottom?: string;
            colgroupValueSettingMargin?: string;
            colgroupValueSettingPadding?: string;
            designFieldActionsBackgroundColor?: string;
            designFieldActionsGap?: string;
            designFieldActionsLiColor?: string;
            designFieldActionsMargin?: string;
            designFieldActionsPadding?: string;
            designFieldDataSourceFormItemStaticBackgroundColorHover?: string;
            designFieldDataSourceFormItemStaticBorderRadius?: string;
            designFieldDataSourceFormItemStaticCombinationGap?: string;
            designFieldDataSourceFormItemStaticFlex?: string;
            designFieldDataSourceFormItemStaticFlexShrink?: string;
            designFieldDataSourceFormItemStaticGap?: string;
            designFieldDataSourceFormItemStaticMarginTop?: string;
            designFieldDataSourceFormItemStaticMinWidth?: string;
            designFieldDataSourceFormItemStaticOpacity?: string;
            designFieldDataSourceFormItemStaticPadding?: string;
            designFieldDataSourceFormItemStaticTextColor?: string;
            designFieldDataSourceFormItemStaticTextColorHover?: string;
            designFieldDataSourceFormItemStaticTransitionDuration?: string;
            designFieldDataSourceFormItemStaticWidth?: string;
            designFieldWrapperActiveBorder?: string;
            designFieldWrapperActiveReserveBottom?: string;
            designFieldWrapperHoverBorder?: string;
            designFieldWrapperLabelBackgroundColor?: string;
            designFieldWrapperLabelBorderRadius?: string;
            designFieldWrapperLabelColor?: string;
            designFieldWrapperLabelGap?: string;
            designFieldWrapperLabelIconSize?: string;
            designFieldWrapperLabelPadding?: string;
            designFieldWrapperOutlineWidth?: string;
            designFieldWrapperPadding?: string;
            designWrapperPropertiesMaxWidth?: string;
            droppableContainerBorder?: string;
            droppableContainerMinHeight?: string;
            droppableContainerMinWidth?: string;
            droppableContainerOverBorderColor?: string;
            fdAccentSoft?: string;
            fdBorder?: string;
            fdBorderStrong?: string;
            fdDesignBodyRowBg?: string;
            fdDesignEditorBg?: string;
            fdDesignEditorBodyMobileBg?: string;
            fdDesignEditorBodyMobilePadding?: string;
            fdDesignEditorBodyPadding?: string;
            fdDesignEditorHeaderBg?: string;
            fdDesignEditorHeaderBorderBottom?: string;
            fdDesignEditorHeaderBorderTop?: string;
            fdDesignEditorHeaderPadding?: string;
            fdDesignEditorMobileViewportMinHeight?: string;
            fdDesignEditorMobileViewportWidth?: string;
            fdDesignEditorViewportBg?: string;
            fdDesignEditorViewportLabelColor?: string;
            fdDesignEditorViewportMobileBorder?: string;
            fdDesignEditorViewportMobilePadding?: string;
            fdDesignEditorViewportMobileRadius?: string;
            fdDesignEditorViewportMobileShadow?: string;
            fdDesignEditorViewportMobileSurface?: string;
            fdDesignEditorViewportPadding?: string;
            fdDesignPreviewModalBodyBg?: string;
            fdDesignPreviewModalBodyPadding?: string;
            fdDesignPreviewModalDesktopBg?: string;
            fdDesignPreviewModalDesktopBorder?: string;
            fdDesignPreviewModalDesktopRadius?: string;
            fdDesignPreviewModalFooterBg?: string;
            fdDesignPreviewModalFooterBorderColor?: string;
            fdDesignPreviewModalFooterGap?: string;
            fdDesignPreviewModalFooterPadding?: string;
            fdDesignPreviewModalHeaderPadding?: string;
            fdDesignPreviewModalMobileBg?: string;
            fdDesignPreviewModalMobileBorder?: string;
            fdDesignPreviewModalMobileMarginBlock?: string;
            fdDesignPreviewModalMobileMinHeight?: string;
            fdDesignPreviewModalMobilePadding?: string;
            fdDesignPreviewModalMobileRadius?: string;
            fdDesignPreviewModalMobileShadow?: string;
            fdDesignPreviewModalToolbarBorderColor?: string;
            fdDesignPreviewModalToolbarGap?: string;
            fdDesignPreviewModalToolbarPadding?: string;
            fdDesignPreviewValuesJsonModalBorderColor?: string;
            fdDesignPreviewValuesJsonModalBorderRadius?: string;
            fdDesignPreviewValuesJsonModalGap?: string;
            fdDesignPropertiesBorderColor?: string;
            fdDesignPropertiesEmptyColor?: string;
            fdDesignPropertiesEmptyFontSize?: string;
            fdDesignPropertiesEmptyGap?: string;
            fdDesignPropertiesEmptyIconBg?: string;
            fdDesignPropertiesEmptyIconBorder?: string;
            fdDesignPropertiesEmptyIconColor?: string;
            fdDesignPropertiesEmptyIconFontSize?: string;
            fdDesignPropertiesEmptyIconShadow?: string;
            fdDesignPropertiesEmptyIconSize?: string;
            fdDesignPropertiesEmptyPadding?: string;
            fdDesignPropertiesEmptyTextMaxWidth?: string;
            fdDesignPropertiesMinWidth?: string;
            fdDesignPropertiesOuterPadding?: string;
            fdDesignPropertiesShadow?: string;
            fdDesignPropertiesTabsPadding?: string;
            fdDesignPropertiesWidth?: string;
            fdDesignToolbarBg?: string;
            fdDesignToolbarDividerColor?: string;
            fdDesignToolbarDividerHeight?: string;
            fdDesignToolbarDividerMarginInline?: string;
            fdDesignToolbarDividerWidth?: string;
            fdDesignToolbarEllipsisMinWidth?: string;
            fdDesignToolbarGap?: string;
            fdDesignToolbarGroupBg?: string;
            fdDesignToolbarGroupBorderColor?: string;
            fdDesignToolbarGroupGap?: string;
            fdDesignToolbarGroupPadding?: string;
            fdDesignToolbarGroupRadius?: string;
            fdDesignToolbarGroupShadow?: string;
            fdDesignToolbarIconActiveColor?: string;
            fdDesignToolbarIconColor?: string;
            fdDesignToolbarIconFontSize?: string;
            fdDesignToolbarIconHoverBg?: string;
            fdDesignToolbarIconHoverColor?: string;
            fdDesignToolbarIconSize?: string;
            fdDesignToolbarInnerPaddingBlock?: string;
            fdDesignToolbarInnerPaddingInline?: string;
            fdDesignToolbarItemActiveBg?: string;
            fdDesignToolbarItemActiveRadius?: string;
            fdDesignToolbarItemGap?: string;
            fdDesignToolbarItemMinHeight?: string;
            fdDesignToolbarMenuItemDisabledOpacity?: string;
            fdDesignToolbarMenuJustify?: string;
            fdDesignToolbarOverflowMenuMaxWidth?: string;
            fdDesignToolboxBodyScrollPadding?: string;
            fdDesignToolboxBodyScrollPaddingBottom?: string;
            fdDesignToolboxBodyScrollPaddingRight?: string;
            fdDesignToolboxBorderColor?: string;
            fdDesignToolboxDragOverlayShadow?: string;
            fdDesignToolboxGroupTitleAccent?: string;
            fdDesignToolboxGroupTitleColor?: string;
            fdDesignToolboxGroupTitleSize?: string;
            fdDesignToolboxInnerPadding?: string;
            fdDesignToolboxItemBg?: string;
            fdDesignToolboxItemBorderColor?: string;
            fdDesignToolboxItemFontSize?: string;
            fdDesignToolboxItemHoverBg?: string;
            fdDesignToolboxItemHoverBorderColor?: string;
            fdDesignToolboxItemHoverShadow?: string;
            fdDesignToolboxItemIconColor?: string;
            fdDesignToolboxItemIconGap?: string;
            fdDesignToolboxItemIconHoverColor?: string;
            fdDesignToolboxItemIconSize?: string;
            fdDesignToolboxItemLabelColor?: string;
            fdDesignToolboxItemLabelHoverColor?: string;
            fdDesignToolboxItemPadding?: string;
            fdDesignToolboxItemRadius?: string;
            fdDesignToolboxItemShadow?: string;
            fdDesignToolboxMaxWidth?: string;
            fdDesignToolboxMinWidth?: string;
            fdDesignToolboxPadding?: string;
            fdDesignToolboxScrollbarThumb?: string;
            fdDesignToolboxSearchBg?: string;
            fdDesignToolboxSearchBorderColor?: string;
            fdDesignToolboxSearchFocusBorder?: string;
            fdDesignToolboxSearchFocusShadow?: string;
            fdDesignToolboxSearchMarginBottom?: string;
            fdDesignToolboxSearchRadius?: string;
            fdDesignToolboxSearchShadow?: string;
            fdDesignToolboxShadow?: string;
            fdDesignToolboxWidth?: string;
            fdDesignValueJsonModalBorderColor?: string;
            fdDesignValueJsonModalBorderRadius?: string;
            fdDesignValueJsonModalGap?: string;
            fdFieldTipGap?: string;
            fdPreviewMobileViewportWidth?: string;
            fdRadiusLg?: string;
            fdRadiusMd?: string;
            fdRadiusSm?: string;
            fdRichEditorDisabledOpacity?: string;
            fdRichEditorHeight?: string;
            fdRichEditorMinHeight?: string;
            fdShadowSm?: string;
            fdShadowXs?: string;
            fdSurface?: string;
            fdSurfaceMuted?: string;
            fdSurfaceSubtle?: string;
            fdTemplateCardBg?: string;
            fdTemplateCardBorderColor?: string;
            fdTemplateCardDescColor?: string;
            fdTemplateCardDescSize?: string;
            fdTemplateCardFocusRing?: string;
            fdTemplateCardGap?: string;
            fdTemplateCardHoverBg?: string;
            fdTemplateCardHoverBorderColor?: string;
            fdTemplateCardHoverShadow?: string;
            fdTemplateCardInnerGap?: string;
            fdTemplateCardMinWidth?: string;
            fdTemplateCardPadding?: string;
            fdTemplateCardRadius?: string;
            fdTemplateCardTitleColor?: string;
            fdTemplateCardTitleSize?: string;
            fdTemplateCardTitleWeight?: string;
            fdTemplateModalPadding?: string;
            fdTextPrimary?: string;
            fdTextSecondary?: string;
            fdTextTertiary?: string;
            i18nChangeFormItemPrefixIconMarginBottom?: string;
            i18nChangeFormItemPrefixIconMarginRight?: string;
            i18nChangeFormItemPrefixIconWidth?: string;
            i18nChangeFormItemSuccessIconColor?: string;
            imageCaptchaBorder?: string;
            imageCaptchaBorderRadius?: string;
            imageCaptchaGap?: string;
            imageCaptchaHeight?: string;
            imageCaptchaWidth?: string;
            imageUploadCropModalBodyGap?: string;
            imageUploadCropModalCropBoxCircleRadius?: string;
            imageUploadCropModalCropBoxDiamondClip?: string;
            imageUploadCropModalCropBoxTriangleClip?: string;
            imageUploadCropModalCropperBackground?: string;
            imageUploadCropModalCropperBorderRadius?: string;
            imageUploadCropModalCropperHeight?: string;
            imageUploadCropModalSliderMinWidth?: string;
            imageUploadCropModalSliderRowGap?: string;
            imageUploadCropModalSliderValueWidth?: string;
            imageUploadCropModalToolbarGap?: string;
            imageUploadListThumbCircleRadius?: string;
            imageUploadListThumbDiamondClip?: string;
            imageUploadListThumbTriangleClip?: string;
            layoutDroppableContainerPaddingBottom?: string;
            layoutSlotsContainerBorder?: string;
            layoutSlotsContainerMinHeight?: string;
            layoutSlotsContainerMinWidth?: string;
            layoutSlotsContainerPaddingBottom?: string;
            pagingSettingFormBg?: string;
            pagingSettingFormPadding?: string;
            pagingSettingFormRadius?: string;
            phoneWithAreaCodeAddonWidth?: string;
            phoneWithAreaCodeCodeWidth?: string;
            phoneWithAreaCodeOptionCountryLineHeight?: string;
            phoneWithAreaCodeOptionDialLineHeight?: string;
            phoneWithAreaCodeOptionDialOpacity?: string;
            phoneWithAreaCodeOptionFlagLineHeight?: string;
            phoneWithAreaCodeOptionGap?: string;
            phoneWithAreaCodeOptionLeftGap?: string;
            phoneWithAreaCodeOptionLeftMinWidth?: string;
            phoneWithAreaCodePhoneMinWidth?: string;
            phoneWithAreaCodePopupMinWidth?: string;
            phoneWithAreaCodeWidth?: string;
            sendSmsDataSourcePickerActionsGap?: string;
            sendSmsDataSourcePickerGap?: string;
            sendSmsDataSourcePickerInfoBorder?: string;
            sendSmsDataSourcePickerInfoBorderRadius?: string;
            sendSmsDataSourcePickerInfoEmptyOpacity?: string;
            sendSmsDataSourcePickerInfoHeight?: string;
            sendSmsDataSourcePickerInfoLineHeight?: string;
            sendSmsDataSourcePickerInfoMinWidth?: string;
            sendSmsDataSourcePickerInfoPadding?: string;
            sendSmsDataSourcePickerManagerTriggerBorder?: string;
            sendSmsDataSourcePickerManagerTriggerBorderRadius?: string;
            sendSmsDataSourcePickerManagerTriggerSize?: string;
            sendSmsDataSourcePickerSelectWidth?: string;
            sendSmsSendWidth?: string;
            sendSmsWidth?: string;
            sloatLabelWrapperGap?: string;
            sloatLabelWrapperMarginBottom?: string;
            tableDataSourceDynamicGap?: string;
            tableDataSourceFormGap?: string;
            tableGridLayoutColgroupSettingItemGap?: string;
            tableGridLayoutColgroupSettingItemNotLastChildMarginBottom?: string;
            tableGridLayoutColgroupSettingItemSettingGap?: string;
            tableGridLayoutColgroupSettingMargin?: string;
            tableGridLayoutColgroupSettingPadding?: string;
            tableGridLayoutVerticalLabelPadding?: string;
            tableGridLayoutVerticalValuePadding?: string;
            tableSelectColumnSettingHandleHeight?: string;
            tableSelectColumnSettingHandleWidth?: string;
            tableSelectColumnSettingHeaderMarginBottom?: string;
            tableSelectColumnSettingItemPadding?: string;
            tableSelectColumnSettingItemRadius?: string;
            tableSelectColumnSettingListGap?: string;
            tableSelectColumnSettingModalRowGap?: string;
            tableSelectColumnSettingModalRowMarginBottom?: string;
            tableSelectColumnSettingModalViewportGap?: string;
            tableSelectColumnSettingModalWidth?: string;
            tableSelectColumnSettingRowGap?: string;
            tableSelectColumnSettingWidthInputMinWidth?: string;
            tableSelectionSearchButtonMinWidth?: string;
            tableSelectionSearchInputMinWidth?: string;
            tableSelectionSearchMarginBottom?: string;
            toolBoxGroupBodyListGridColumnGap?: string;
            toolBoxGroupBodyListGridRowGap?: string;
            toolBoxGroupBodyListMargin?: string;
            toolBoxGroupBodyListPadding?: string;
            treeSelectionContentMaxHeight?: string;
            treeSelectionSearchButtonMinWidth?: string;
            treeSelectionSearchInputMinWidth?: string;
            treeSelectionSearchMarginBottom?: string;
            uploadDataSourceManagerFormItemActionsGap?: string;
            uploadDataSourceManagerFormItemGap?: string;
            uploadDataSourceManagerFormItemInfoBorder?: string;
            uploadDataSourceManagerFormItemInfoBorderRadius?: string;
            uploadDataSourceManagerFormItemInfoEmptyOpacity?: string;
            uploadDataSourceManagerFormItemInfoHeight?: string;
            uploadDataSourceManagerFormItemInfoLineHeight?: string;
            uploadDataSourceManagerFormItemInfoMinWidth?: string;
            uploadDataSourceManagerFormItemInfoPadding?: string;
            uploadDataSourceManagerFormItemManagerTriggerBorder?: string;
            uploadDataSourceManagerFormItemManagerTriggerBorderRadius?: string;
            uploadDataSourceManagerFormItemManagerTriggerSize?: string;
            uploadDataSourceManagerFormItemSelectWidth?: string;
            uploadDataSourceManagerFormItemWidth?: string;
        };
    };
};
/**
