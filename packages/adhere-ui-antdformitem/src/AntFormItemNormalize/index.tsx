...
export const FloatButton = createFactory(AntFloatButton, {});
...
export const QRCode = createFactory(AntQRCode, {});
...
export const Tour = createFactory(AntTour, {});
...
export const Watermark = createFactory(AntWatermark, {});
