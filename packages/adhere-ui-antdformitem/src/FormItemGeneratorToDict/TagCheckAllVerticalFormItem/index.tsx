...
import { Checkbox, Tag } from '../../AntFormItemNormalize';
 ...
 * @constructor
 */
const TagCheckAllVerticalFormItem: FC<TagCheckAllFormItemProps> = ({ dataSource, ...props }) => {
  ...
  return (
    <div>
      ...
      <div>
        <TagVerticalFormItem {...props} renderItem={onRenderItem} dataSource={dataSource} />
      </div>
    </div>
  );
};

export default TagCheckAllVerticalFormItem;
