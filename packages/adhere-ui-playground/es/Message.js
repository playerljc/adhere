let selectPrefix="adhere-ui-playground-message";export default{success(e){let c=document.createElement("div");c.className=selectPrefix,c.innerHTML=`
      <div>
    ...
    `,document.body.appendChild(c),setTimeout(()=>{c.querySelector(`.${selectPrefix}-notice`).classList.add(selectPrefix+"-move-up-leave"),setTimeout(()=>c?.parentElement?.removeChild(c),300)},4e3)}};
