 ...
 */
export type CodeBoxConfigItem = CodeBoxPlayGroundProps | CodeBoxPlayGroundMultiProps | CodeBoxPlayGroundTabProps | CodeBoxPlayGroundMobileTabProps;
/**
 * 代码盒子PlayGround配置接口
...
export interface CodeBoxPlayGroundProps extends PlayGroundProps {
    ...
    type: 'PlayGround';
    /** 自定义包装渲染函数 */
    renderWrap?: (columnIndex: number, index: number, config: CodeBoxConfigItem[], children: ReactNode) => ReactNode;
    /** 自定义子元素渲染函数 */
    renderChildren?: (columnIndex: number, index: number, config: CodeBoxConfigItem[]) => ReactNode;
}
/**
