export { DateFieldDependencyProvider, getDateDependenciesDisabledDate, isEndDateField, isStartDateField, useDateFieldDependency, } from './dependency';
export { createDatePickerWithStatics } from './createDatePickerWithStatics';
export type { DateFieldDependencyProviderProps, DatePickerProps, } from './types';
declare const _default: (<ValueType = import("dayjs").Dayjs, IsMultiple extends boolean = false>(props: import("antd/es/date-picker/generatePicker/interface").PickerPropsWithMultiple<import("dayjs").Dayjs, import("antd/es/date-picker/generatePicker").PickerProps<import("dayjs").Dayjs>, ValueType, IsMultiple>) => React.ReactElement) & {
    displayName?: string;
} & {
    displayName?: string;
    ...
    BirthdayPicker: import("react").FC<import("./BirthdayPicker").BirthdayPickerProps>;
    BoundedTimePicker: import("react").FC<import("./BoundedTimePicker").BoundedTimePickerProps>;
    DateFieldDependencyProvider: typeof import("./dependency").DateFieldDependencyProvider;
};
