...
declare const SearchEditorCellTable_base: {
    new (props: any): {
        [x: string]: any;
 ...
 * @classdesc 可编辑单元格的表格
 */
declare class SearchEditorCellTable<P extends SearchTableImplementProps, S extends SearchTableImplementState> extends SearchEditorCellTable_base {
    /**
