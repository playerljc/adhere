...
declare const SearchEditorTable_base: {
    new (props: any): {
        [x: string]: any;
 ...
 */
declare class SearchEditorTable<P extends SearchTableImplementProps, S extends SearchEditorTableState> extends SearchEditorTable_base {
    /**
     * updateEditorData
