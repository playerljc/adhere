export default [
  ...
  'Quase {value} semanas',
  'Quase {value} meses',
  'Último {value} trimestre',
  'Quase {value} anos',
  'Quase {value} horas',
  'Quase {value} minutos',
  'Quase {value} segundos',
  'Quase {value} milissegundos',
  '{value} dias no futuro',
  'Próximas {value} semanas',
  'Próximos {value} meses',
  'Trimestre {valor} futuro',
  '{value} anos no futuro',
  '{value} horas no futuro',
  '{value} minutos no futuro',
