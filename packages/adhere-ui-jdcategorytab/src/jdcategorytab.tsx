...
const JdCategoryTab: ForwardRefRenderFunction<JdCategoryTabRefHandle, JdCategoryTabProps> = (
  ...
  function scrollTo(key: string, time?: number, easing?: any) {
    easing = easing || ease.current.circular;
    ...
    scroll.current.scrollToElement(findElByKey(key), time, null, null, easing);
