import { getConfig, updateConfig, resetConfig } from './WarnPrompt';
...
export type { WarnDialogProps, WarnDialog, WarnPromptComponent, WarnPromptConfig, Duration } from './types';
export { openWarnMessage, openWarnDialog, getConfig, updateConfig, resetConfig } from './WarnPrompt';
