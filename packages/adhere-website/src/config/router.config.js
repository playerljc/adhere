...
const ConditionalRender = lazy(() => import(/* webpackChunkName: "conditionalrender" */ '@/components/ui/conditionalrender'));
const DelConfirm = lazy(() => import(/* webpackChunkName: "delconfirm" */ '@/components/ui/delconfirm'));
const ImportantConfirm = lazy(() => import(/* webpackChunkName: "importantconfirm" */ '@/components/ui/importantconfirm'));
const GlobalIndicator = lazy(() => import(/* webpackChunkName: "globalindicator" */ '@/components/ui/globalindicator'));
const Spin = lazy(() => import(/* webpackChunkName: "spin" */ '@/components/ui/spin'));
const HistoryBack = lazy(() => import(/* webpackChunkName: "historyback" */ '@/components/ui/historyback'));
const SuccessPrompt = lazy(() => import(/* webpackChunkName: "successprompt" */ '@/components/ui/successprompt'));
const ErrorPrompt = lazy(() => import(/* webpackChunkName: "errorprompt" */ '@/components/ui/errorprompt'));
const WarnPrompt = lazy(() => import(/* webpackChunkName: "warnprompt" */ '@/components/ui/warnprompt'));
const ImageLazy = lazy(() => import(/* webpackChunkName: "imagelazy" */ '@/components/ui/imagelazy'));
const MessageDialog = lazy(() => import(/* webpackChunkName: "messagedialog" */ '@/components/ui/messagedialog'));
const Permission = lazy(() => import(/* webpackChunkName: "permission" */ '@/components/ui/permission'));
const Suspense = lazy(() => import(/* webpackChunkName: "suspense" */ '@/components/ui/suspense'));
const TableHeadSearch = lazy(() => import(/* webpackChunkName: "tableheadsearch" */ '@/components/ui/tableheadsearch'));
...
const FlexLayout = lazy(() => import(/* webpackChunkName: "flexlayout" */ '@/components/ui/flexlayout'));
const SplitLayout = lazy(() => import(/* webpackChunkName: "splitlayout" */ '@/components/ui/splitlayout'));
const StickupLayout = lazy(() => import(/* webpackChunkName: "stickuplayout" */ '@/components/ui/stickuplayout'));
const Surnames = lazy(() => import(/* webpackChunkName: "surnames" */ '@/components/ui/surnames'));
const SliderScale = lazy(() => import(/* webpackChunkName: "sliderscale" */ '@/components/ui/sliderscale'));
const Revolving = lazy(() => import(/* webpackChunkName: "revolving" */ '@/components/ui/revolving'));
const ScrollLoad = lazy(() => import(/* webpackChunkName: "scrollload" */ '@/components/ui/scrollload'));
const JCategoryTab = lazy(() => import(/* webpackChunkName: "jcategorytab" */ '@/components/ui/jdcategorytab'));
const CascadeCompared = lazy(() => import(/* webpackChunkName: "cascadecompared" */ '@/components/ui/cascadecompared'));
const SlideLayout = lazy(() => import(/* webpackChunkName: "slidelayout" */ '@/components/ui/slidelayout'));
const ContextMenu = lazy(() => import(/* webpackChunkName: "contextmenu" */ '@/components/ui/contextmenu'));
const FontSizeSetting = lazy(() => import(/* webpackChunkName: "fontsizesetting" */ '@/components/ui/fontsizesetting'));
const SearchTable = lazy(() => import(/* webpackChunkName: "searchtable" */ '@/components/ui/searchtable'));
const FormItemCreator = lazy(() => import(/* webpackChunkName: "formitemcreator" */ '@/components/ui/formitemcreator'));
const TableList = lazy(() => import(/* webpackChunkName: "tablelist" */ '@/components/ui/tablelist'));
const Popup = lazy(() => import(/* webpackChunkName: "popup" */ '@/components/ui/popup'));
const BackTopAnimation = lazy(() => import(/* webpackChunkName: "backtopanimation" */ '@/components/ui/backtopanimation'));
const PullRefresh = lazy(() => import(/* webpackChunkName: "pullrefresh" */ '@/components/ui/pullrefresh'));
...
const AdapterScreen = lazy(() => import(/* webpackChunkName: "adapterscreen" */ '@/components/util/adapterscreen'));
const Decorators = lazy(() => import(/* webpackChunkName: "decorators" */ '@/components/util/decorators'));
...
const Preferences = lazy(() => import(/* webpackChunkName: "preferences" */ '@/components/util/preferences'));
