 ...
 * @param props.children - 子元素，依次为顶部、底部、左侧、中心、右侧区域
 * @param ref - 组件引用
 * @returns 渲染的布局组件
 */
declare const TBLCRLayout: React.NamedExoticComponent<TBLRCSplitLayoutProps & React.RefAttributes<HTMLDivElement>>;
