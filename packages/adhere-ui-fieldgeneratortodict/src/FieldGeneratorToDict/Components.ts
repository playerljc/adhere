...
const Components = {
  ...
  Transfer: {
    ...
    Tree: 'TransferTree',
    TreeFlat: 'TransferTreeFlat',
    TreeLeaf: 'TransferTreeLeaf',
    TreeCascade: 'TransferTreeCascade',
    Table: 'TransferTable',
    TreeSelect: 'TransferTreeSelect',
    TreeSelectFlat: 'TransferTreeSelectFlat',
    TreeSelectLeaf: 'TransferTreeSelectLeaf',
    TreeSelectCascade: 'TransferTreeSelectCascade',
  ...
  TransferDynamic: {
    ...
    TreeFlat: 'TransferDynamicTreeFlat',
    TreeLeaf: 'TransferDynamicTreeLeaf',
    TreeCascade: 'TransferDynamicTreeCascade',
    Table: 'TransferDynamicTable',
    TreeSelect: 'TransferDynamicTreeSelect',
    TreeSelectFlat: 'TransferDynamicTreeSelectFlat',
    TreeSelectLeaf: 'TransferDynamicTreeSelectLeaf',
    TreeSelectCascade: 'TransferDynamicTreeSelectCascade',
