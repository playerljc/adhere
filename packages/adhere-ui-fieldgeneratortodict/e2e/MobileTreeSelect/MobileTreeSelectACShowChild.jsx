...
export default () => {
  ...
  // const DictComponentName = `SystemTreeACFlat${FieldGeneratorToDict.ComponentNames.MobileTreeSelectAC.ShowChild}`;
  ...
  const DictComponent =
    FieldGeneratorToDict.Components[
      FieldGeneratorToDict.genDictComponentName(
        ...
        FieldGeneratorToDict.ComponentNames.MobileTreeSelectAC.ShowChild,
      )
    ];
