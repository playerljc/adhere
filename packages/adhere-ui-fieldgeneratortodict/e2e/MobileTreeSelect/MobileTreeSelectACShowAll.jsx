...
export default () => {
  ...
  // const DictComponentName = `SystemTreeACFlat${FieldGeneratorToDict.ComponentNames.MobileTreeSelectAC.ShowAll}`;
  ...
  const DictComponent =
    FieldGeneratorToDict.Components[
      FieldGeneratorToDict.genDictComponentName(
        ...
        FieldGeneratorToDict.ComponentNames.MobileTreeSelectAC.ShowAll,
      )
    ];
