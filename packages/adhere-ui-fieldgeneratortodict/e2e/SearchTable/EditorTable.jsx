...
const { EditableTableControl } = SearchTable;

// const DictComponentName = `SystemTable${FieldGeneratorToDict.ComponentNames.SearchTable.EditorTable}`;
const DictComponent = FieldGeneratorToDict.Components[
  FieldGeneratorToDict.genDictComponentName(
    // @ts-ignore
    names.SystemTable,
    FieldGeneratorToDict.ComponentNames.SearchTable.EditorTable,
  )
]({
  override: {
    getColumns() {
    ...
    renderSearchFooterItems(defaultItems) {
      return this.applySuper('renderSearchFooterItems', [
        [
          {
            key: 'editorTable',
            value: (
