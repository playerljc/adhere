...
// const DictComponentName = `SystemTable${FieldGeneratorToDict.ComponentNames.SearchTable.AsyncSingleSelect}`;
const DictComponent = FieldGeneratorToDict.Components[
  FieldGeneratorToDict.genDictComponentName(
    // @ts-ignore
    names.SystemTable,
    FieldGeneratorToDict.ComponentNames.SearchTable.AsyncSingleSelect,
  )
]({
  override: {
    getColumns() {
