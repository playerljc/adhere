...
// const DictComponentName = `SystemTreeTable${FieldGeneratorToDict.ComponentNames.SearchTable.TreeSingleSelect}`;
const DictComponent = FieldGeneratorToDict.Components[
  FieldGeneratorToDict.genDictComponentName(
    // @ts-ignore
    names.SystemTreeTable,
    FieldGeneratorToDict.ComponentNames.SearchTable.TreeSingleSelect,
  )
]({
  override: {
    getColumns() {
