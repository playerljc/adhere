 ...
 * ```
 */
export default function TableHeadSearch(
  render: FilterDropdownRender,
  icon: React.ReactNode = <SearchOutlined />
): TableHeadSearchResult {
  return {
    filterIcon: () => icon,
    filterDropdown: (props: FilterDropdownProps) => render(props),
  };
}
