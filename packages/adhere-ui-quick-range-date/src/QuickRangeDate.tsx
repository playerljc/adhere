...
const labelByTypeMap = new Map<DateType, (value?: number) => string>([
  ['a-d', (value) => Intl.get('past_days', { value })],
  ['a-w', (value) => Intl.get('past_weeks', { value })],
  ['a-M', (value) => Intl.get('past_months', { value })],
  ['a-Q', (value) => Intl.get('past_quarters', { value })],
  ['a-y', (value) => Intl.get('past_years', { value })],
  ['a-h', (value) => Intl.get('past_hours', { value })],
  ['a-m', (value) => Intl.get('past_minutes', { value })],
  ['a-s', (value) => Intl.get('past_seconds', { value })],
  ['a-ms', (value) => Intl.get('past_milliseconds', { value })],
  ['b-d', (value) => Intl.get('future_days', { value })],
  ['b-w', (value) => Intl.get('future_weeks', { value })],
  ['b-M', (value) => Intl.get('future_months', { value })],
  ['b-Q', (value) => Intl.get('future_quarters', { value })],
  ['b-y', (value) => Intl.get('future_years', { value })],
  ['b-h', (value) => Intl.get('future_hours', { value })],
  ['b-m', (value) => Intl.get('future_minutes', { value })],
  ['b-s', (value) => Intl.get('future_seconds', { value })],
  ['b-ms', (value) => Intl.get('future_milliseconds', { value })],
