 ...
 * @template T - 状态类型
 */
export type SetStateWithCallback<T> = (action: React.SetStateAction<T>, callback?: SetStateCallback<T>) => void;
/**
 ...
 * @template T - 状态类型
 */
export type UsePropToState = <T>(propValue: T, options?: UsePropToStateOptions<T>) => UsePropToStateReturn<T>;
/**
