...
class SortableTable<RecordType extends object = any> extends React.Component<TSortTableProps<RecordType>> {
  state = {
  ...
  DraggableBodyRow = ({ className, style, ...restProps }) => {
    ...
    return (
      <SortableItem
        index={index}
        {...this.props.sortable && typeof this.props.sortable !== 'boolean' && this.props.sortable.itemProps}
        {...restProps}
      />
    );
  };
  ...
  */
  DraggableContainer = (containerProps) => (
    <SortableWrapper
      ...
      distance={2}
      {...this.props.sortable && typeof this.props.sortable !== 'boolean' && this.props.sortable.containerProps}
      {...containerProps}
    />
  );
