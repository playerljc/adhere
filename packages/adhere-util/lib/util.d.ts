declare const _default: {
    ...
    GermanNumberFormatter(value: string | number, precision?: number, options?: import("./numberFormatter").NumberFormatterOptions): string;
    GermanNumberParse(value: string): string;
    USNumberFormatter(value: string | number, precision?: number, options?: import("./numberFormatter").NumberFormatterOptions): string;
    USNumberParse(value: string): string;
    FrenchNumberFormatter(value: string | number, precision?: number, options?: import("./numberFormatter").NumberFormatterOptions): string;
    FrenchNumberParse(value: string): string;
    InternationalNumberFormatter(value: string | number, precision?: number, options?: import("./numberFormatter").NumberFormatterOptions): string;
    InternationalNumberParse(value: string): string;
    setNumberFormatterUseScientificNotation: typeof import("./numberFormatter").setNumberFormatterUseScientificNotation;
    getNumberFormatterUseScientificNotation: typeof import("./numberFormatter").getNumberFormatterUseScientificNotation;
