...
import React, { type ErrorInfo, type RefObject, createRef, forwardRef } from 'react';
 ...
 * @param Component
 */
function ReactErrorBoundariesHOC<ComponentProps>(Component: ReactComponent<ComponentProps>) {
  class ReactErrorBoundaries extends React.Component<any, IReactErrorBoundariesState> {
    ...
    refIns: RefObject<ReactComponent> | null = null;
    ...
    render() {
      ...
      if (Util.isArray(Component)) {
        if (Component.prototype.isReactComponent) {
          this.refIns = forwardedRef ?? createRef();
 ...
 */
ReactErrorBoundariesHOC.setDefaultErrorUI = function (defaultErrorUI: ReactElement) {
