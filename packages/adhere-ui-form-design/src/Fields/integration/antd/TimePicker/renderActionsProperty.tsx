...
export function ActionsProperty({
  ...
  return (
    <Form name="antTimePickerActionsProperty" form={form} onFieldsChange={onFieldsChange}>
...
export function renderActionsProperty(props: DesignValueProps): ReactNode {
  return <ActionsProperty designValue={props} actions={values.TimePickerEvents?.value ?? []} />;
}
