...
export function ActionsProperty({
  ...
  return (
    <Form name="antTimeRangePickerActionsProperty" form={form} onFieldsChange={onFieldsChange}>
...
export function renderActionsProperty(props: DesignValueProps): ReactNode {
  return (
    <ActionsProperty designValue={props} actions={values.TimeRangePickerEvents?.value ?? []} />
  );
}
