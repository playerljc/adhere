...
const MainProperty = createMainProperty({
  formName: 'antTimeRangePickerMainProperty',
  getDefaultFormItems: (_designValue, ctx): DataItemRow[] => [
    ...
    },
    {
      key: 'order',
      require: false,
      label: <Label>{Intl.get('date_order')}：</Label>,
      value: (
        <Value>
          <Form.Item name="order">
            <WhetherRadioHorizontalDict placeholder={Intl.get('date_order')} />
          </Form.Item>
        </Value>
      ),
    },
      ...
      value: (
        <Value>
          <Form.Item name="showNow">
            <WhetherRadioHorizontalDict placeholder={Intl.get('show_now')} />
          </Form.Item>
        </Value>
      ),
    },
      ...
      value: (
        <Value>
          <Form.Item name="use12Hours">
            <WhetherRadioHorizontalDict placeholder="use12Hours" />
          </Form.Item>
        </Value>
      ),
    },
