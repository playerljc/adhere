...
export function ActionsProperty({
  ...
  return (
    <Form name="antDateRangePickerActionsProperty" form={form} onFieldsChange={onFieldsChange}>
...
export function renderActionsProperty(props: DesignValueProps): ReactNode {
  return (
    <ActionsProperty designValue={props} actions={values.DateRangePickerEvents?.value ?? []} />
  );
}
