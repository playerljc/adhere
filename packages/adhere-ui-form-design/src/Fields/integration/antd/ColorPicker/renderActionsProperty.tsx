...
export function ActionsProperty({
  ...
  return (
    <Form name="antColorPickerActionsProperty" form={form} onFieldsChange={onFieldsChange}>
...
export function renderActionsProperty(props: DesignValueProps): ReactNode {
  return <ActionsProperty designValue={props} actions={values.ColorPickerEvents?.value ?? []} />;
}
