...
export function ActionsProperty({
  ...
  return (
    <Form name="antTreeSelectionActionsProperty" form={form} onFieldsChange={onFieldsChange}>
...
export function renderActionsProperty(props: DesignValueProps): ReactNode {
  return <ActionsProperty designValue={props} actions={values.TreeEvents?.value ?? []} />;
}
