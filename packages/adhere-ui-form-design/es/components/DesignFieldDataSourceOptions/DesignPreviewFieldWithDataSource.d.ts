 ...
 */
export declare function DesignPreviewFieldWithDataSource({ fieldProps, formItemProps, style, actions, designOptionsKey, children, }: DesignPreviewFieldWithDataSourceProps): React.JSX.Element;
